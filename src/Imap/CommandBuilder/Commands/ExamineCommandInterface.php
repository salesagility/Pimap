...
/**
 * Interface ExamineCommandInterface
 * @package SalesAgility\Imap\CommandBuilder\Commands
 */
interface ExamineCommandInterface
{
    /**
     * Selects a mailbox returns the same output; however,
     * the selected mailbox is identified as read-only.
     * No changes to the permanent state of the mailbox are made
