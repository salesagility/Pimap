 ...
 */
interface AppendCommandArgumentsInterface
{
    /**
     * @param $flag
     * @return \SalesAgility\Imap\CommandBuilder\CommandBuildInterface|AppendCommandArgumentsInterface
     */
    ...
    /**
     * @param string $message eg. RFC822 message
     * @return \SalesAgility\Imap\CommandBuilder\CommandBuildInterface|AppendCommandArgumentsInterface
     */
