...
/**
 * Class PimapCommandBuilder
 * @package SalesAgility\Imap\CommandBuilder
 */
class PimapCommandBuilder implements Singleton, PimapSupportedTopLevelCommandsInterface, PimapSupportedCommandsInterface, CommandBuildInterface, CommandBuildArgumentsInterface, CommandValidatorAwareInterface
{
