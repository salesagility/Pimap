...
class PhpImapExtensionCommandBuilderTest extends \Codeception\Test\Unit
{
    /** @var ReflectionClass */
    ...
    protected function _before()
    {
        if (self::$reflection === null) {
            ...
            self::$reflection = new \ReflectionClass(PhpImapExtensionCommandBuilder::class);
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance();
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->raw('test')->build()->untagged();
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->raw('test')->build()->tagged('A1');
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->raw('test')->build()->command();
        $this->assertEquals('test', $object);
    }

    public function testCommandArguments()
    {
        $object = PhpImapExtensionCommandBuilder::instance()->login()->user('user')->password('password');
        $expect = array(
            'USER' => 'user',
            'PASSWORD' => 'password'
        );
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->raw('test')->build();
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->raw('test');
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
        $this->assertEquals('test', self::$propertyCommand->getValue($object));
        $this->assertEquals(array(), self::$propertyArguments->getValue($object));
        $this->assertEquals(' test', self::$propertyAsString->getValue($object));
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->noop();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
        $this->assertEquals('NOOP', self::$propertyCommand->getValue($object));
        $this->assertEquals(array(), self::$propertyArguments->getValue($object));
        $this->assertEquals(' NOOP', self::$propertyAsString->getValue($object));
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->uid()->fetch(1)->header()->body()->flags()->uids();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
        ...
        $object = PhpImapExtensionCommandBuilder::instance()->uid()->fetchRange(1, 2)->header()->body()->flags()->uids();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
        $this->assertEquals('UID', self::$propertyCommand->getValue($object));
        $this->assertEquals(array(
            'FETCH' => array(
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->fetch(1)->header()->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->fetchRange(1, 2)->header()->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
        $this->assertEquals('FETCH', self::$propertyCommand->getValue($object));
        $this->assertEquals(array(
            'MESSAGE' => '1:2',
    ...
    public function testFetchSet()
    {
        ...
        $object = PhpImapExtensionCommandBuilder::instance()->fetchSet($messageList)->header()->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
        $this->assertEquals('FETCH', self::$propertyCommand->getValue($object));
        $this->assertEquals(array(
            'MESSAGE' => '1,3',
        ...
        $object = PhpImapExtensionCommandBuilder::instance()->uid()->fetchSet($messageList)->header()->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
        $this->assertEquals('UID', self::$propertyCommand->getValue($object));
        $this->assertEquals(array(
            'FETCH' => array(
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->fetch(1)->uids()->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
        $this->assertEquals('FETCH', self::$propertyCommand->getValue($object));
        $this->assertEquals(array(
            'MESSAGE' => 1,
        ...
        $object = PhpImapExtensionCommandBuilder::instance()->uid()->fetchRange(1,2)->header()->body()->flags()->uids()->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
        $this->assertEquals('UID', self::$propertyCommand->getValue($object));
        $this->assertEquals(array(
            'FETCH' => array(
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->fetch(1)->flags();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
        $this->assertEquals('FETCH', self::$propertyCommand->getValue($object));
        $this->assertEquals(array(
            'MESSAGE' => 1,
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->fetch(1)->header();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
        $this->assertEquals('FETCH', self::$propertyCommand->getValue($object));
        $this->assertEquals(array(
            'MESSAGE' => 1,
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->fetch(1)->body();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
        $this->assertEquals('FETCH', self::$propertyCommand->getValue($object));
        $this->assertEquals(array(
            'MESSAGE' => 1,
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->select('drafts')->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->logout();
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->login();
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->login()->user('username');
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->login()->user('username')->password('password');
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->examine('drafts')->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->create('drafts')->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->delete('drafts')->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->subscribe('drafts')->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->unsubscribe('drafts')->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->listMailbox()->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->listSubsetMailbox()->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->rename('INVOICES', 'RECEIPTS')->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->close()->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->expunge()->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->append('IN')->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->append('IN')->withFlag('Seen')->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
        $this->assertEquals('APPEND', self::$propertyCommand->getValue($object));
        $this->assertEquals(array(
            'MAILBOX' => 'IN',
    ...
    public function testWithDate()
    {
        ...
        $object = PhpImapExtensionCommandBuilder::instance()->append('IN')->withFlag('Seen')->withDateTime($date)->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
        $this->assertEquals('APPEND', self::$propertyCommand->getValue($object));
        $this->assertEquals(array(
            'MAILBOX' => 'IN',
    ...
    public function testWithMessage()
    {
        ...
        $date = DateTimeImmutable::createFromFormat('Y-m-d H:i:s', '2018-01-01 1:00:00');
        $object = PhpImapExtensionCommandBuilder::instance()->append('IN')->withFlag('Seen')->withDateTime($date)->withMessage($message)->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
        $this->assertEquals('APPEND', self::$propertyCommand->getValue($object));
        $this->assertEquals(array(
            'MAILBOX' => 'IN',
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->check()->build();
        $this->assertEquals('', self::$propertyCommandPrefix->getValue($object));
    ...
    {
        $object = PhpImapExtensionCommandBuilder::instance()->copy()->withRange(1, 2)->toMailbox('IN')->build();
        ...
        $object = PhpImapExtensionCommandBuilder::instance()->uid()->copy()->withRange(1, 2)->toMailbox('IN')->build();
    ...
    public function testSearch()
    {
        ...
        $searchCommand = PhpImapExtensionCommandBuilder::instance()
            ->search()
        ...
        $searchUidCommand = PhpImapExtensionCommandBuilder::instance()
            ->uid()
            ->search()
            ->withSequence($messageList)
            ->withRange(1, 2)
    ...
    {
        $statusCommand = PhpImapExtensionCommandBuilder::instance()
            ->status('IN')
            ->withRecent()
            ->withUidNext()
            ->withUidValidity()
    ...
    public function testStore()
    {
        ...
        $statusUidCommand = PhpImapExtensionCommandBuilder::instance()
            ->uid()
            ->store()
            ->withRange(1, 2)
            ->addFlag('Answered')
